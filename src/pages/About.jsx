    ...
    <section className="py-20 bg-background text-text">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg text-textSecondary">
        ...
        <div className="mt-20 grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 leading-8 text-textSecondary">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-4 text-textSecondary">
        ...
        <div className="mt-20 rounded-3xl bg-primary p-12 text-center text-white">
          ...
          <button className="mt-8 rounded-xl bg-white px-8 py-3 font-semibold text-primary transition hover:bg-gray-100">
            Get Started
          </button>
        </div>
      </div>
